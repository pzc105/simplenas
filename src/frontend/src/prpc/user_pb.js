...
goog.exportSymbol('proto.prpc.QueryVideoInfoReq', null, global);
goog.exportSymbol('proto.prpc.QueryVideoInfoRes', null, global);
goog.exportSymbol('proto.prpc.RefreshSubtitleReq', null, global);
goog.exportSymbol('proto.prpc.RefreshSubtitleRes', null, global);
 ...
 * @constructor
 */
proto.prpc.QueryVideoInfoReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.prpc.QueryVideoInfoReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.prpc.QueryVideoInfoReq.displayName = 'proto.prpc.QueryVideoInfoReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.prpc.QueryVideoInfoRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.prpc.QueryVideoInfoRes.repeatedFields_, null);
};
goog.inherits(proto.prpc.QueryVideoInfoRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.prpc.QueryVideoInfoRes.displayName = 'proto.prpc.QueryVideoInfoRes';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.prpc.RefreshSubtitleReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.prpc.RefreshSubtitleReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.prpc.RefreshSubtitleReq.displayName = 'proto.prpc.RefreshSubtitleReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.prpc.RefreshSubtitleRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.prpc.RefreshSubtitleRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.prpc.RefreshSubtitleRes.displayName = 'proto.prpc.RefreshSubtitleRes';
}
 ...
 * @return {!Object}
 */
proto.prpc.QueryVideoInfoReq.prototype.toObject = function(opt_includeInstance) {
  return proto.prpc.QueryVideoInfoReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.prpc.QueryVideoInfoReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prpc.QueryVideoInfoReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemId: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.prpc.QueryVideoInfoReq}
 */
proto.prpc.QueryVideoInfoReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.prpc.QueryVideoInfoReq;
  return proto.prpc.QueryVideoInfoReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.prpc.QueryVideoInfoReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.prpc.QueryVideoInfoReq}
 */
proto.prpc.QueryVideoInfoReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.prpc.QueryVideoInfoReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.prpc.QueryVideoInfoReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.prpc.QueryVideoInfoReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prpc.QueryVideoInfoReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getItemId();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.prpc.QueryVideoInfoReq.prototype.getItemId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.prpc.QueryVideoInfoReq} returns this
 */
proto.prpc.QueryVideoInfoReq.prototype.setItemId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @const
 */
proto.prpc.QueryVideoInfoRes.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.prpc.QueryVideoInfoRes.prototype.toObject = function(opt_includeInstance) {
  return proto.prpc.QueryVideoInfoRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.prpc.QueryVideoInfoRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prpc.QueryVideoInfoRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    videoId: jspb.Message.getFieldWithDefault(msg, 1, 0),
    subtitlesList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.prpc.QueryVideoInfoRes}
 */
proto.prpc.QueryVideoInfoRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.prpc.QueryVideoInfoRes;
  return proto.prpc.QueryVideoInfoRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.prpc.QueryVideoInfoRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.prpc.QueryVideoInfoRes}
 */
proto.prpc.QueryVideoInfoRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.prpc.QueryVideoInfoRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.prpc.QueryVideoInfoRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.prpc.QueryVideoInfoRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prpc.QueryVideoInfoRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.prpc.QueryVideoInfoRes.prototype.getVideoId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.prpc.QueryVideoInfoRes} returns this
 */
proto.prpc.QueryVideoInfoRes.prototype.setVideoId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Array<string>}
 */
proto.prpc.QueryVideoInfoRes.prototype.getSubtitlesList = function() {
 ...
 * @return {!proto.prpc.QueryVideoInfoRes} returns this
 */
proto.prpc.QueryVideoInfoRes.prototype.setSubtitlesList = function(value) {
  return jspb.Message.setField(this, 2, value || []);
};
 ...
 * @return {!proto.prpc.QueryVideoInfoRes} returns this
 */
proto.prpc.QueryVideoInfoRes.prototype.addSubtitles = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 2, value, opt_index);
};
 ...
 * @return {!proto.prpc.QueryVideoInfoRes} returns this
 */
proto.prpc.QueryVideoInfoRes.prototype.clearSubtitlesList = function() {
 ...
 * @return {!Object}
 */
proto.prpc.RefreshSubtitleReq.prototype.toObject = function(opt_includeInstance) {
  return proto.prpc.RefreshSubtitleReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.prpc.RefreshSubtitleReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prpc.RefreshSubtitleReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemId: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.prpc.RefreshSubtitleReq}
 */
proto.prpc.RefreshSubtitleReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.prpc.RefreshSubtitleReq;
  return proto.prpc.RefreshSubtitleReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.prpc.RefreshSubtitleReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.prpc.RefreshSubtitleReq}
 */
proto.prpc.RefreshSubtitleReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.prpc.RefreshSubtitleReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.prpc.RefreshSubtitleReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.prpc.RefreshSubtitleReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prpc.RefreshSubtitleReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getItemId();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.prpc.RefreshSubtitleReq.prototype.getItemId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.prpc.RefreshSubtitleReq} returns this
 */
proto.prpc.RefreshSubtitleReq.prototype.setItemId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.prpc.RefreshSubtitleRes.prototype.toObject = function(opt_includeInstance) {
  return proto.prpc.RefreshSubtitleRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.prpc.RefreshSubtitleRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prpc.RefreshSubtitleRes.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.prpc.RefreshSubtitleRes}
 */
proto.prpc.RefreshSubtitleRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.prpc.RefreshSubtitleRes;
  return proto.prpc.RefreshSubtitleRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.prpc.RefreshSubtitleRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.prpc.RefreshSubtitleRes}
 */
proto.prpc.RefreshSubtitleRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.prpc.RefreshSubtitleRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.prpc.RefreshSubtitleRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.prpc.RefreshSubtitleRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prpc.RefreshSubtitleRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
