...
var file_user_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x32, 0xd2, 0x0f, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x72, 0x72, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x73, 0x70, 0x12, 0x39, 0x0a, 0x0b, 0x47, 0x65, 0x74,
	0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x2e, 0x70, 0x72, 0x70, 0x63, 0x2e,
	0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x1a, 0x14,
	0x2e, 0x70, 0x72, 0x70, 0x63, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x73, 0x70, 0x12, 0x3c, 0x0a, 0x0a, 0x4f, 0x6e, 0x42, 0x74, 0x53, 0x74, 0x61, 0x74,
...
var file_user_proto_depIdxs = []int32{
	...
	66, // 34: prpc.UserService.GetPeerInfo:input_type -> prpc.GetPeerInfoReq
	67, // 35: prpc.UserService.OnBtStatus:input_type -> prpc.BtStatusRequest
	18, // 36: prpc.UserService.QueryBtVideos:input_type -> prpc.QueryBtVideosReq
	...
	14, // 39: prpc.UserService.RenameItem:input_type -> prpc.RenameItemReq
	21, // 40: prpc.UserService.AddBtVideos:input_type -> prpc.AddBtVideosReq
	25, // 41: prpc.UserService.ShareItem:input_type -> prpc.ShareItemReq
	27, // 42: prpc.UserService.QuerySharedItems:input_type -> prpc.QuerySharedItemsReq
	29, // 43: prpc.UserService.DelSharedItem:input_type -> prpc.DelSharedItemReq
	16, // 44: prpc.UserService.QuerySubItems:input_type -> prpc.QuerySubItemsReq
	23, // 45: prpc.UserService.QueryItemInfo:input_type -> prpc.QueryItemInfoReq
	32, // 46: prpc.UserService.UploadSubtitle:input_type -> prpc.UploadSubtitleReq
	54, // 47: prpc.UserService.RenameBtVideoName:input_type -> prpc.RenameBtVideoNameReq
	34, // 48: prpc.UserService.GetBtMeta:input_type -> prpc.GetBtMetaReq
	36, // 49: prpc.UserService.NewBtHlsTask:input_type -> prpc.NewBtHlsTaskReq
	39, // 50: prpc.UserService.JoinChatRoom:input_type -> prpc.JoinChatRoomReq
	42, // 51: prpc.UserService.SendMsg2ChatRoom:input_type -> prpc.SendMsg2ChatRoomReq
	44, // 52: prpc.UserService.AddMagnetCategory:input_type -> prpc.AddMagnetCategoryReq
	46, // 53: prpc.UserService.AddMagnetUri:input_type -> prpc.AddMagnetUriReq
	48, // 54: prpc.UserService.QueryMagnet:input_type -> prpc.QueryMagnetReq
	50, // 55: prpc.UserService.DelMagnetCategory:input_type -> prpc.DelMagnetCategoryReq
	3,  // 56: prpc.UserService.Register:output_type -> prpc.RegisterRet
	5,  // 57: prpc.UserService.IsUsedEmail:output_type -> prpc.IsUsedEmailRet
	7,  // 58: prpc.UserService.Login:output_type -> prpc.LoginRet
	7,  // 59: prpc.UserService.FastLogin:output_type -> prpc.LoginRet
	7,  // 60: prpc.UserService.IsLogined:output_type -> prpc.LoginRet
	9,  // 61: prpc.UserService.ChangePassword:output_type -> prpc.ChangePasswordRsp
	68, // 62: prpc.UserService.Download:output_type -> prpc.DownloadRespone
	69, // 63: prpc.UserService.RemoveTorrent:output_type -> prpc.RemoveTorrentRes
	70, // 64: prpc.UserService.GetMagnetUri:output_type -> prpc.GetMagnetUriRsp
	53, // 65: prpc.UserService.GetTorrents:output_type -> prpc.GetTorrentsRsp
	71, // 66: prpc.UserService.GetPeerInfo:output_type -> prpc.GetPeerInfoRsp
	72, // 67: prpc.UserService.OnBtStatus:output_type -> prpc.BtStatusRespone
	20, // 68: prpc.UserService.QueryBtVideos:output_type -> prpc.QueryBtVideosRes
	11, // 69: prpc.UserService.NewCategoryItem:output_type -> prpc.NewCategoryItemRes
	13, // 70: prpc.UserService.DelCategoryItem:output_type -> prpc.DelCategoryItemRes
	15, // 71: prpc.UserService.RenameItem:output_type -> prpc.RenameItemRes
	22, // 72: prpc.UserService.AddBtVideos:output_type -> prpc.AddBtVideosRes
	26, // 73: prpc.UserService.ShareItem:output_type -> prpc.ShareItemRes
	28, // 74: prpc.UserService.QuerySharedItems:output_type -> prpc.QuerySharedItemsRes
	30, // 75: prpc.UserService.DelSharedItem:output_type -> prpc.DelSharedItemRes
	17, // 76: prpc.UserService.QuerySubItems:output_type -> prpc.QuerySubItemsRes
	24, // 77: prpc.UserService.QueryItemInfo:output_type -> prpc.QueryItemInfoRes
	33, // 78: prpc.UserService.UploadSubtitle:output_type -> prpc.UploadSubtitleRes
	55, // 79: prpc.UserService.RenameBtVideoName:output_type -> prpc.RenameBtVideoNameRsp
	35, // 80: prpc.UserService.GetBtMeta:output_type -> prpc.GetBtMetaRsp
	37, // 81: prpc.UserService.NewBtHlsTask:output_type -> prpc.NewBtHlsTaskRsp
	41, // 82: prpc.UserService.JoinChatRoom:output_type -> prpc.JoinChatRoomRes
	43, // 83: prpc.UserService.SendMsg2ChatRoom:output_type -> prpc.SendMsg2ChatRoomRes
	45, // 84: prpc.UserService.AddMagnetCategory:output_type -> prpc.AddMagnetCategoryRsp
	47, // 85: prpc.UserService.AddMagnetUri:output_type -> prpc.AddMagnetUriRsp
	49, // 86: prpc.UserService.QueryMagnet:output_type -> prpc.QueryMagnetRsp
	51, // 87: prpc.UserService.DelMagnetCategory:output_type -> prpc.DelMagnetCategoryRsp
